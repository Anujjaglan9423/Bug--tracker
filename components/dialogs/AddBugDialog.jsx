...
export default function AddBugDialog({ open, onOpenChange, projectId, moduleId }) {
  const { addBug } = useBugTracker()
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Create a new bug report for this module.</DialogDescription>
        </DialogHeader>
